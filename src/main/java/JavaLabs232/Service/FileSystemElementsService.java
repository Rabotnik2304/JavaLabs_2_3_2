package JavaLabs232.Service;

import JavaLabs232.Model.FileSystemElement;
...
public class FileSystemElementsService {
    ...
    private static void GetFileSystemElement(File fileSystemElement) {
        if (fileSystemElement.isFile()) {
            ...
            fileSystemElementsInCurrentDir.add(new JavaLabs232.Model.File(
                    currentFileName,
            ...
            fileSystemElementsInCurrentDir.add(new JavaLabs232.Model.Directory(
                    currentDirName,
